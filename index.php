...
<head>
    ...
    <style background-image= "fondo_madera_02.jpg" background-size="cover" background-repeat="no-repeat" background-position="center center"></style>
...
<!----------------------------------
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col p-3 bg-primary text-white">columna 1</div>
                <div class="col p-3  bg-dark text-white">columna 2</div>
                <div class="col p-3  bg-primary text-white">columna 3</div>
            </div>
        </div>
    </div>
---->
            ...
            <div><br><br><br><br></div>
                <div class="container-fluid justify-content-center">
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Seguinos en las redes</a>
                        </li>
                        <li class="nav-item">
