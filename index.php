        ...
        <div class="col-sm-8 main-section">
            <div class="modal-content">
                ...
                <form class="col-12" action="index.php" method="post">
                    ...
                    <button type="submit" name="btnLogin" value="Iniciar sesión" class="btn btn-primary" ><i class="fas fa-sign-in-alt"></i>  Ingresar </button>
            ...
            <!--         
                    ...
                    <div class="col-12 forgot">
                        <a href="#" class="text-center">Nuevo Usuario></a>    
                    </div>
            -->        
                </form>
                <!--
